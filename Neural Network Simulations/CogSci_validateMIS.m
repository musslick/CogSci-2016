...
function [pathwayCapacities, maxCarryingCapacity, BK_MIS, A_bipartite, A_tasksIdx, multiPerformance_mean, multiPerformance_sem, MSEdata, A_dual, A_dual_scores] = CogSci_validateMIS(taskNet, tasksToPerform, R_hidden, R_output, corr_threshold, multiCap)
    ...
    good_multiTaskConditions = zeros(size(BK_MIS,2), NPathways*NPathways); % holds task input patterns for good multitasking conditions
